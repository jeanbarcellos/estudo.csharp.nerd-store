...
namespace NerdStore.Vendas.Application.Tests.Pedidos
{
    public class PedidoCommandHandlerTests
    {
        ...
        [Trait("Unit", "Vendas.Application - Pedido Command Handler")]
        public async Task AtualizarItem_ItemExistentePedidoInexistente_DeveOcorrerErroELancarNotificacao()
        {
            // Arrange
            var pedidoCommand = new AtualizarItemPedidoCommand(_clienteId, _produtoId, 5);
        ...
        [Trait("Unit", "Vendas.Application - Pedido Command Handler")]
        public async Task AtualizarItem_ItemInexistentePedidoExistente_DeveOcorrerErroELancarNotificacao()
        {
            // Arrange
            var pedidoCommand = new AtualizarItemPedidoCommand(_clienteId, _produtoId, 5);
